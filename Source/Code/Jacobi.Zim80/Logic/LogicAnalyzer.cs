...
namespace Jacobi.Zim80.Logic
{
    public class LogicAnalyzer : MultipleInputGate
    {
        ...
        private readonly List<BusDataInputStream> _busStreams = new List<BusDataInputStream>();
        private readonly List<DigitalInputStream> _digitalStreams = new List<DigitalInputStream>();
        ...
        public IEnumerable<DigitalInputStream> SignalStreams { get { return _digitalStreams; } }

        public IEnumerable<BusDataInputStream> BusStreams { get { return _busStreams; } }
        ...
        private void InitializeStreams()
        {
            ...
            _digitalStreams.Add(new DigitalInputStream(_clock.DigitalSignal));

            foreach (var input in Inputs)
            {
                if (!input.IsConnected) continue;
                _digitalStreams.Add(new DigitalInputStream(input.DigitalSignal));
            }
            ...
            foreach (var bus in _busInputs)
            {
                ...
                _busStreams.Add(new BusDataInputStream(bus.Bus));
            }
        }
