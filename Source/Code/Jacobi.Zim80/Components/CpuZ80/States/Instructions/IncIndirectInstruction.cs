...
{
    internal class IncIndirectInstruction : IndirectRegisterInstruction
    {
        public IncIndirectInstruction(Die die) 
            : base(die)
        { }
        ...
        protected override CpuState GetInstructionPart(MachineCycleNames machineCycle)
        {
            switch (machineCycle)
            {
                ...
                case MachineCycleNames.M3:
                    ...
                    _instructionM3.Data = new OpcodeByte(Die.Alu.Inc8(_instructionM2.Data.Value));
