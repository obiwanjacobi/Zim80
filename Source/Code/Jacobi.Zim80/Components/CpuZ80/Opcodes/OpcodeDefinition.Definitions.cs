...
namespace Jacobi.Zim80.Components.CpuZ80.Opcodes
{
    partial class OpcodeDefinition
    {
        ...
        public static readonly OpcodeDefinition[] Defintions = new OpcodeDefinition[]
        {
            ...
            new OpcodeDefinition { X = 3, Z = 0, Y = 3, Mnemonic = "RET C", Cycles = new[] { 5, 3, 3 }, AltCycles = new[] { 5 } },
            new OpcodeDefinition { X = 3, Z = 0, Y = 4, Mnemonic = "RET PO", Cycles = new[] { 5, 3, 3 }, AltCycles = new[] { 5 } },
            new OpcodeDefinition { X = 3, Z = 0, Y = 5, Mnemonic = "RET PE", Cycles = new[] { 5, 3, 3 }, AltCycles = new[] { 5 } },
            new OpcodeDefinition { X = 3, Z = 0, Y = 6, Mnemonic = "RET P", Cycles = new[] { 5, 3, 3 }, AltCycles = new[] { 5 } },
            new OpcodeDefinition { X = 3, Z = 0, Y = 7, Mnemonic = "RET M", Cycles = new[] { 5, 3, 3 }, AltCycles = new[] { 5 } },
            ...
            new OpcodeDefinition { X = 3, Z = 1, Q = 1, P = 0, Mnemonic = "RET", Cycles = new[] { 4, 3, 3 } },
            ...
            new OpcodeDefinition { X = 3, Z = 4, Y = 2, Mnemonic = "CALL NC, {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 }, AltCycles = new[] { 4, 3, 3 } },
            new OpcodeDefinition { X = 3, Z = 4, Y = 3, Mnemonic = "CALL C, {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 }, AltCycles = new[] { 4, 3, 3 } },
            new OpcodeDefinition { X = 3, Z = 4, Y = 4, Mnemonic = "CALL PO, {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 }, AltCycles = new[] { 4, 3, 3 } },
            new OpcodeDefinition { X = 3, Z = 4, Y = 5, Mnemonic = "CALL PE, {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 }, AltCycles = new[] { 4, 3, 3 } },
            new OpcodeDefinition { X = 3, Z = 4, Y = 6, Mnemonic = "CALL P, {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 }, AltCycles = new[] { 4, 3, 3 } },
            new OpcodeDefinition { X = 3, Z = 4, Y = 7, Mnemonic = "CALL M, {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 }, AltCycles = new[] { 4, 3, 3 } },
            ...
            new OpcodeDefinition { X = 3, Z = 5, Q = 1, P = 0, Mnemonic = "CALL {0}", nn = true, Cycles = new[] { 4, 3, 4, 3, 3 } },
            ...
            new OpcodeDefinition { X = 1, Z = 0, Y = 3, Mnemonic = "BIT 3, B", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 0, Y = 4, Mnemonic = "BIT 4, B", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 0, Y = 5, Mnemonic = "BIT 5, B", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 0, Y = 6, Mnemonic = "BIT 6, B", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 0, Y = 7, Mnemonic = "BIT 7, B", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },

            new OpcodeDefinition { X = 1, Z = 1, Y = 0, Mnemonic = "BIT 0, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 1, Mnemonic = "BIT 1, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 2, Mnemonic = "BIT 2, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 3, Mnemonic = "BIT 3, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 4, Mnemonic = "BIT 4, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 5, Mnemonic = "BIT 5, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 6, Mnemonic = "BIT 6, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 1, Y = 7, Mnemonic = "BIT 7, C", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },

            new OpcodeDefinition { X = 1, Z = 2, Y = 0, Mnemonic = "BIT 0, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 1, Mnemonic = "BIT 1, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 2, Mnemonic = "BIT 2, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 3, Mnemonic = "BIT 3, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 4, Mnemonic = "BIT 4, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 5, Mnemonic = "BIT 5, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 6, Mnemonic = "BIT 6, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 2, Y = 7, Mnemonic = "BIT 7, D", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },

            new OpcodeDefinition { X = 1, Z = 3, Y = 0, Mnemonic = "BIT 0, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 1, Mnemonic = "BIT 1, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 2, Mnemonic = "BIT 2, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 3, Mnemonic = "BIT 3, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 4, Mnemonic = "BIT 4, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 5, Mnemonic = "BIT 5, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 6, Mnemonic = "BIT 6, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 3, Y = 7, Mnemonic = "BIT 7, E", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },

            new OpcodeDefinition { X = 1, Z = 4, Y = 0, Mnemonic = "BIT 0, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 1, Mnemonic = "BIT 1, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 2, Mnemonic = "BIT 2, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 3, Mnemonic = "BIT 3, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 4, Mnemonic = "BIT 4, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 5, Mnemonic = "BIT 5, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 6, Mnemonic = "BIT 6, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 4, Y = 7, Mnemonic = "BIT 7, H", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },

            new OpcodeDefinition { X = 1, Z = 5, Y = 0, Mnemonic = "BIT 0, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 1, Mnemonic = "BIT 1, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 2, Mnemonic = "BIT 2, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 3, Mnemonic = "BIT 3, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 4, Mnemonic = "BIT 4, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 5, Mnemonic = "BIT 5, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 6, Mnemonic = "BIT 6, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 5, Y = 7, Mnemonic = "BIT 7, L", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            ...
            new OpcodeDefinition { X = 1, Z = 7, Y = 0, Mnemonic = "BIT 0, A", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 7, Y = 1, Mnemonic = "BIT 1, A", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 7, Y = 2, Mnemonic = "BIT 2, A", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 7, Y = 3, Mnemonic = "BIT 3, A", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
            new OpcodeDefinition { X = 1, Z = 7, Y = 4, Mnemonic = "BIT 4, A", Ext1 = 0xCB, Cycles = new[] { 4, 4 } },
